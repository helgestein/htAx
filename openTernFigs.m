...
%{
ternHandles.buttonXRDPlot = uicontrol('Parent', tabMatch, ...
    'Style', 'pushbutton', ...
    'String', 'XRD Plot', ...
    'Units', 'Normalized', ...
    'Position', [leftColOffset (topRowOffset - rowSpace) ...
...
ternHandles.editConfFactor = uicontrol('Parent', tabMatch, ...
    ...
    'UserData', 0.5, ...
    'Units', 'Normalized', ...
    'Position', [(rightColOffset + 0.25) (topRowOffset - rowSpace) ...
...
ternHandles.textTol = uicontrol('Parent', tabMatch, ...
    ...
    'String', 'Tol', ...
    'Units', 'Normalized', ...
    'Position', [leftColOffset + buttonWidth + 0.02 (topRowOffset - rowSpace) ...
    0.15 buttonHeight]);
...
ternHandles.editTol = uicontrol('Parent', tabMatch, ...
    ...
    'UserData', 0.25, ...
    'Units', 'Normalized', ...
    'Position', [(leftColOffset + buttonWidth + 0.17 + 0.02) (topRowOffset - rowSpace) ...
    buttonWidth / 2 buttonHeight]);
