...
htextEC = uicontrol(fReadInFig, 'Style', 'text', 'String', 'EC', ...
    'Units', 'Normalized', ...
    'Position', [leftColOffset (topRowOffset - 1 * textSpacingVert) ...
    textWidth textHeight]);
...
hbuttonEC = uicontrol(fReadInFig, 'Style', 'pushbutton', ...
    'String', 'Select folder', 'Units', 'Normalized', ...
    'Position', [(leftColOffset + colSpacing) ...
    (topRowOffset - 1 * textSpacingVert) ...
    buttonWidth buttonHeight], ...
...
hbuttonImport = uicontrol(fReadInFig, 'Style', 'pushbutton', ...
    ...
    'Position', [buttonMiddleHor (topRowOffset - 5 * textSpacingVert) ...
    buttonWidth buttonHeight], ...
...
htextECFolder = uicontrol(fReadInFig, 'Style', 'text', 'String', '', ...
    'Units', 'Normalized', ...
    'Position', [fileLeftOffset (topRowOffset - textSpacingVert * 1) ...
    fileWidth fileHeight]);
...
heditECXCoord = uicontrol(fReadInFig, ...
    'Style', 'edit', ...
    'Units', 'Normalized', ...
    'Position', [xCoordCol (topRowOffset - 1 * textSpacingVert) ...
    0.08 textHeight], ...
    'Callback', {@editCoordCallback, 2});
heditECYCoord = uicontrol(fReadInFig, ...
    'Style', 'edit', ...
    'Units', 'Normalized', ...
    'Position', [yCoordCol (topRowOffset - 1 * textSpacingVert) ...
    0.08 textHeight], ...
    'Callback', {@editCoordCallback, 3});
heditECDelim = uicontrol(fReadInFig, ...
    'Style', 'edit', ...
    'Units', 'Normalized', ...
    'Position', [delimCol (topRowOffset - 1 * textSpacingVert) ...
    0.08 textHeight], ...
    'Callback', {@editDelimCallback, 1});
heditECEnd = uicontrol(fReadInFig, ...
    'Style', 'edit', ...
    'Units', 'Normalized', ...
    'Position', [endCol (topRowOffset - 1 * textSpacingVert) ...
    0.08 textHeight], ...
...
htextLabelA = uicontrol(fReadInFig, ...
    ...
    'String', 'A', ...
    'Units', 'Normalized', ...
    'Position', [xCoordCol (topRowOffset - textSpacingVert * 2) ...
    0.04 textHeight]);
heditLabelA = uicontrol(fReadInFig, ...
    'Style', 'edit', ...
    'String', '', ...
    'Units', 'Normalized', ...
    'Position', [xCoordCol + 1 * labelOffset (topRowOffset - textSpacingVert * 2) ...
    0.04 textHeight], ...
...
htextLabelB = uicontrol(fReadInFig, ...
    ...
    'String', 'B', ...
    'Units', 'Normalized', ...
    'Position', [xCoordCol + 2 * labelOffset (topRowOffset - textSpacingVert * 2) ...
    0.04 textHeight]);
heditLabelB = uicontrol(fReadInFig, ...
    'Style', 'edit', ...
    'String', '', ...
    'Units', 'Normalized', ...
    'Position', [xCoordCol + 3 * labelOffset (topRowOffset - textSpacingVert * 2) ...
    0.04 textHeight], ...
...
htextLabelC = uicontrol(fReadInFig, ...
    ...
    'String', 'C', ...
    'Units', 'Normalized', ...
    'Position', [xCoordCol + 4 * labelOffset (topRowOffset - textSpacingVert * 2) ...
    0.04 textHeight]);
heditLabelC = uicontrol(fReadInFig, ...
    'Style', 'edit', ...
    'String', '', ...
    'Units', 'Normalized', ...
    'Position', [xCoordCol + 5 * labelOffset (topRowOffset - textSpacingVert * 2) ...
    0.04 textHeight], ...
