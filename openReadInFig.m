...
htextTitle = uicontrol(fReadInFig, 'Style', 'text', 'String', 'Import Data', ...
    'FontSize', titleFontSize, ...
    'Units', 'Normalized', ...
    'Position', [titleMiddleHor titleBottomOffset titleWidth titleHeight]);
...
%{
htextOr = uicontrol(fReadInFig, 'Style', 'text', 'String', 'Or:', ...
    'Units', 'Normalized', ...
    'Position', [leftColOffset (topRowOffset - 5 * textSpacingVert) ...
    textWidth textHeight]);
%}

htextRestore = uicontrol(fReadInFig, 'Style', 'text', 'String', 'Restore', ...
    'Units', 'Normalized', ...
    'Position', [leftColOffset (topRowOffset - 5 * textSpacingVert) ...
    textWidth textHeight]);

htextSaveRestore = uicontrol(fReadInFig, 'Style', 'text', 'String', 'Save to', ...
    'Units', 'Normalized', ...
...
hbuttonEC = uicontrol(fReadInFig, 'Style', 'pushbutton', ...
    'String', 'Select folder', 'Units', 'Normalized', ...
    'Position', [(leftColOffset + colSpacing) (topRowOffset - 2 * textSpacingVert) ...
    buttonWidth buttonHeight]);
hbuttonSave = uicontrol(fReadInFig, 'Style', 'pushbutton', ...
    'String', 'Select file', 'Units', 'Normalized', ...
    'Position', [(leftColOffset + colSpacing) (topRowOffset - 3 * textSpacingVert) ...
    buttonWidth buttonHeight], ...
...
hbuttonRestoreFile = uicontrol(fReadInFig, 'Style', 'pushbutton', ...
    'String', 'Select file', 'Units', 'Normalized', ...
    'Position', [(leftColOffset + colSpacing) (topRowOffset - 5 * textSpacingVert) ...
    buttonWidth buttonHeight], ...
    'Callback', {@buttonRestoreFileCallback});
hbuttonSaveRestore = uicontrol(fReadInFig,'Style', 'pushbutton', ...
    'String', 'Select file', 'Units', 'Normalized', ...
    'Position', [(leftColOffset + colSpacing) (topRowOffset - 6 * textSpacingVert) ...
    buttonWidth buttonHeight], ...
...
htextRestoreFile = uicontrol(fReadInFig, 'Style', 'text', 'String', '', ...
    ...
    fileWidth fileHeight]);
htextSaveRestoreFile = uicontrol(fReadInFig, 'Style', 'text', 'String', '', ...
    'Units', 'Normalized', ...
...
%% callback functions
    ...
    function buttonRestoreFileCallback(hbuttonRestoreFile, eventdata, handles)
    ...
    function buttonSaveRestoreCallback(hbuttonSaveRestore, eventdata, handles)
    ...
    function buttonRestoreCallback(hbuttonRestore, eventdata, handles)
        if restoreFile ~= 0
