function XRDTiNiCufullwaferneu = importXRDFileAll(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   XRDTINICUFULLWAFERNEU = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   XRDTINICUFULLWAFERNEU = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   XRDTiNiCufullwaferneu = importfile('XRD_TiNiCu_full wafer_neu.txt', 1, 299);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/07/19 08:18:06
...
XRDTiNiCufullwaferneu = [dataArray{1:end-1}];
